...
export default {
    ...
    created() {
        ...
        this.fetchCoursescategoriesAll()
    },
    destroyed() {
        this.resetState()
    },
    methods: {
        ...mapActions('CoursesSingle', ['storeData', 'resetState', 'setTitle', 'setInstructor', 'setLessons', 'setCategories', 'setFeatured_image', 'setDescription', 'setIntroduction', 'setDuration', 'fetchUsersAll', 'fetchLessonsAll', 'fetchCoursescategoriesAll']),
        updateTitle(e) {
