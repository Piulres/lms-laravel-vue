...
export default {
    ...
    methods: {
        ...mapActions('LessonsSingle', ['fetchData', 'updateData', 'resetState', 'setTitle', 'setIntroduction', 'setStudy_material', 'destroyStudy_material', 'destroyUploadedStudyMaterial', 'setContent']),
        updateTitle(e) {
